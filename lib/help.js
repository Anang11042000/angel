...
const help = (prefix, cts, premma, pendaftar) => {
    return `
╔══✪〘 INFORMATION 〙✪══
║
╠➥ ANANG BOT
...
╠➥ *${prefix}snk*
╠➥ *${prefix}afk*
╠➥ *${prefix}reminder* [kirim pesan waktu]
╠➥ *${prefix}share* [text]
╠➥ *${prefix}wame*
╠➥ *${prefix}groupinfo*
...
Contoh : *${prefix}googlesearch siapa itu ANANG*
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *ANANG*
