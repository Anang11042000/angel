...
module.exports = welcome = async (tobz, event) => {
    ...
    try {
        if (event.action == 'add' && isWelkom) {
            ...
            const capt = `Assalamualaikum  @${event.who.replace('@c.us', '')} 👋\nSelamat datang di *Grup ${name}*\n═══════════════════\nSelamat bergabung dan juga semoga betah disini dan jangan lupa patuhi aturan di grup ini\n═══════════════════\n*UNTUK DAFTAR JADI MEMBER BOT CARANYA*\n\n*#daftar |isinama kmu|20*\n\n═══════════════════\n`
