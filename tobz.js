...
INGAT JANGAN JUAL SCRIPT anang KEPADA ORANG LAIN!
...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        //const groupMetadata = isGroupMsg ? await tobz.groupMetadata(from) : ''
        ...
        const ownerNumber = '6285747479082@c.us'
...
/*//////////////////////////////////////REMINDER///////////////////////////////////////
        ...
        if (isGroupMsg) {
            ...
            if (afk.checkAfkUser(sender.id, _afk) && !isCmd) {
                ...
                await tobz.sendText(from, `*${pushname}* telah kembali dari AFK! Selamat datang kembali~`, id)
            }
        }
        ...
        function cekumur(obj){
            if (obj === true){
                ...
                return tobz.reply(from, `Kamu belum cukup umur untuk menggunakan anang, min 16 tahun\n\nKamu bisa mendaftar ulang dengan cara donasi terlebih dahulu, bales ${prefix}donasi\nHubungi Owner : wa.me/6285747479082`, id) //if user is not registered
            }
        }
        ...
        // FUNCTION
                ...
                for (let i of stickerspam){
                    if(i.id === id){
                        if (i.msg >= 12) {
                            found === true 
                            tobz.reply(from, `*「 𝗔𝗡𝗧𝗜 𝗦𝗣𝗔𝗠 𝗦𝗧𝗜𝗖𝗞𝗘𝗥 」*\nKamu telah SPAM STICKER di grup, kamu akan di kick otomatis oleh anang`, id).then(() => {
                                tobz.removeParticipant(groupId, id)
                            })
                            return true;
                        }else if(i.msg >= 12){
                            found === true
                            tobz.reply(from, `*「 𝗔𝗡𝗧𝗜 𝗦𝗣𝗔𝗠 𝗦𝗧𝗜𝗖𝗞𝗘𝗥 」*\nKamu terdeteksi spam sticker!\nMohon tidak spam 5 sticker lagi atau nomor akan di kick oleh anang!`, id)
                            return true
                        }else{
                            found === true
                            return false;
            ...
            for (let i of msgBadword){
                if(i.id === id){
                    ...
                    if (msg >= 3) { // 3X BADWORD AKAN TERKENA KICK
                        kasar === true 
                        tobz.reply(from, `*「 𝗔𝗡𝗧𝗜 𝗕𝗔𝗗𝗪𝗢𝗥𝗗 」*\nKamu telah berkata kasar di grup ini, kamu akan di kick otomatis oleh anang!`, id).then(() => {
                            tobz.removeParticipant(groupId, id)
                        })
                        return true;
                    }else{
        ...
        function GenerateSerialNumber(mask){
            ...
            return serialNumber;
                ...
                if(body === '#mute' && isMuted(chatId) == true){
                    if(isGroupMsg) {
                        if (!isAdmin) return tobz.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh admin anang!', id)
                ...
                if (body === '#unbanchat') {
                    if (!isOwner) return tobz.reply(from, 'Maaf, perintah ini hanya dapat dilakukan oleh Owner anang!', id)
        ...
        case prefix+'banchat':
            ...
            if (!isOwner) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh Owner anang!', id)
        ...
        case prefix+'truth':
            if (!quotedMsg) return tobz.reply(from, 'Reply pesannya!', id)
            tobz.reply(from, `${truth()}`, id)
            break
        case prefix+'dare':
            if (!quotedMsg) return tobz.reply(from, 'Reply pesannya!', id)
            tobz.reply(from, `${dare()}`, id)
            break
        case prefix+'unmute':
        ...
        case prefix+'ttp2':
            ...
            if (args.length === 1) return tobz.reply(from, `Kirim perintah *#ttp2 [ Teks ]*, contoh *#ttp2 anang*`, id)
        ...
        case prefix+'blackpink':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah *#blackpink [ Teks ]*, contoh *#blackpink anang*`, id)
            tobz.reply(from, mess.wait, id)
        ...
        case prefix+'pornhub':
            ...
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah *#pornhub [ |Teks1|Teks2 ]*, contoh *#pornhub |Tobz|Dev anang*`, id)
            ...
            if (argz.length >= 2) {
                ...
                await tobz.reply(from, `Wrong Format!\n[❗] Kirim perintah *#pornhub [ |Teks1|Teks2 ]*, contoh *#pornhub |Tobz|Dev anang*`, id)
            }
            break
        case prefix+'glitch':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            if (args.length === 1) return tobz.reply(from, `Kirim perintah *#glitch [ |Teks1|Teks2 ]*, contoh *#glitch |Tobz|Dev anang*`, id)
            argz = body.trim().split('|')
            if (argz.length >= 2) {
                tobz.reply(from, mess.wait, id)
                ...
                await tobz.reply(from, `Wrong Format!\n[❗] Kirim perintah *#glitch [ |Teks1|Teks2 ]*, contoh *#glitch |Tobz|Dev anang*`, id)
            }
            break
        case prefix+'daftar':  // NAMBAHIN NOMOR DI DATABASE
                ...
                const umurnye = argz[2]
                    ...
                    if(umurnye >= 40) return await tobz.reply(from, 'Kamu terlalu tua, kembali lagi ke masa muda untuk menggunakan anang', id)
...
Total Pengguna yang telah terdaftar ${pendaftar.length}`)
            ...
            case prefix+'daftarulang':
                    if (!isAdmin) return tobz.reply(from, 'Command ini hanya dapat digunakan oleh admin anang', id)  
...
${desc}`)
        ...
        case prefix+'owner':
        case prefix+'creator':
            tobz.sendContact(chatId, `6285747479082@c.us`)
            tobz.reply(from, 'Itu nomor owner/majikanku', id)
            break
        ...
        case prefix+'antilink':
            ...
            if (args[1] == 'enable') {
                ...
                tobz.reply(from, `Pilih enable atau disable kakak..`, id)
            }
            break  
        /*case prefix+'hidetag':
            if (!isGroupMsg) return tobz.reply(from, `hanya bisa di group`, id)
            //if (!isOwner) return reply(from, 'kamu siapa?', id)
        ...
        case prefix+'simi':
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh Admin anang!', id) // Hanya Admin yang bisa mengaktifkan
            if (args.length === 1) return tobz.reply(from, 'Pilih enable atau disable!', id)
            if (args[1].toLowerCase() === 'enable') {
        ...
        case prefix+'neonime':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const response2 = await fetch('https://tobz-api.herokuapp.com/api/neonime?q=' + nenon + '&apikey=BotWeA')
        ...
        case prefix+'kusonime':
            ...
            const animeq = await axios.get('https://tobz-api.herokuapp.com/v1/kuso?q=' + body.slice(7) + '&apikey=BotWeA')
        ...
        case prefix+'dewabatch':
            ...
            const animek = await axios.get('https://tobz-api.herokuapp.com/v1/dewabatch?q=' + body.slice(7) +'&apikey=BotWeA')
        ...
        case prefix+'waifu':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            const waifu = await axios.get('https://tobz-api.herokuapp.com/api/waifu?apikey=BotWeA')
        ...
        case prefix+'randomnekonime':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            const nekonime = await axios.get(`https://tobz-api.herokuapp.com/api/nekonime?apikey=BotWeA`)
        ...
        case prefix+'quotesnime':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            const skya = await axios.get('https://tobz-api.herokuapp.com/api/quotesnime/random?apikey=BotWeA')
            skya_ = skya.data
...
🌐️ *URL*: ${url}`
        ...
        case prefix+'shorturl':
            ...
            const surl = await axios.get('https://tobz-api.herokuapp.com/api/shorturl?url=' + sorturl + '&apikey=BotWeA')
        ...
        case prefix+'spamcall':
            ...
            console.log(spam)
            const call2 = await axios.get('https://tobz-api.herokuapp.com/api/spamcall?no=' + spam + '&apikey=BotWeA')
        ...
        case prefix+'play':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            //if (!isAdmin) return tobz.reply(from, `Perintah ini hanya bisa di gunakan oleh Admin anang!`, id)
            //if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            ...
            try {
                ...
                const vhtearyt33 = await vhtearyt3.json()
                 if (vhtearyt33.status == false) {
                    ...
                    if(Number(vhtearyt33.result.size.split(' MB')[0]) >= 30.00) return tobz.sendFileFromUrl(from, 'Maaf durasi video sudah melebihi batas maksimal!', id)
                    const { title, thumb, size, result } = await vhtearyt33.result
                    console.log(`VhTear Giliran ${ext}\n${size}\n${status}`)
                    const captions = `*「 YOUTUBE MP3 」*\n\n• *Judul* : ${title}\n• *Filesize* : ${size}\n\n_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`
                    tobz.sendFileFromUrl(from, thumb, `thumb.jpg`, id)
                    await tobz.sendFile(from, UrlMp3, `${title}.mp3`, '', id)
                    await tobz.sendFileFromUrl(from, result, `${title}.mp3`, '', id).catch(() => tobz.reply(from, mess.error.Yt4, id))
                    await limitAdd(serial)
                }
            } catch (err) {
        ...
        case prefix+'xnxx':
            ...
            try {
                tobz.reply(from, mess.wait, id)
                const resq = await axios.get('http://melodicxt.herokuapp.com/api/xnxx-downloader?url='+ args[1] +'&apiKey=administrator')
...
➸ *Jumlah Postingan:* ${status_count}`
        ...
        case prefix+'igstalk':
            if(isReg(obj)) return
            if(cekumur(obj)) return
            if (!isGroupMsg) return tobz.reply(from, 'khusus di group', id)
            if (isLimit(serial)) return tobz.reply(from, 'maaf umurmu masih kurang untuk menggunakan fitur ini..', id)
            if (args.length === 1)  return tobz.reply(from, 'Kirim perintah *#igstalk @username*\nContoh *#igstalk @anangfatkhurosidin*', id)
            ...
            console.log(istalk)
            try {
                const istalk2 = await axios.get('https://api.vhtear.com/igprofile?query=' + istalk + '&apikey=Anang1104*')
...
➸ Jumlah Postingan: *${post_count}*`
            ...
            /*tobz.reply(from, 'maaf lagi eror', id)
            break*/
...
➸ *Wilayah:* +${region_name}`
        ...
        case prefix+'brainly':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            if (args.length === 1) return tobz.reply(from, 'Kirim perintah *${prefix}brainly <teks>*.', id)
            try {
            ...
            break
            /*const querykbbia = (body.slice(10))
            try {
                const resp = await get(`https://api.vhtear.com/branly?query=${querykbbia}&apikey=Anang1104*`)
                if (resp.data.error) return tobz.reply(from, resp.data.error, id)
                const kbbua = `➸ *Pertanyaan* : ${querykbbia}\n➸ ${resp.data.result.data}`
                tobz.reply(dari, kbbua, id)
            } catch (err) {
                await tobz.sendFileFromUrl(from, errorurl2, 'error.png', '💔️ Maaf, tidak ditemukan')
            }
            break*/
            /*if (args.length >= 2){
        ...
        case prefix+'listdaerah':
            ...
            if(cekumur(cekage)) return
            if (!isGroupMsg) return tobz.reply(from, `Perintah ini hanya bisa di gunakan dalam group!`, id)
            const listDaerah = await axios.get('https://tobz-api.herokuapp.com/api/daerah?apikey=BotWeA')
        ...
        case prefix+'cerpen': // ARUGAZ
            ...
            .then(async (res) => await tobz.reply(from, res.data.data, id))
            .catch(async () => {
        ...
        case prefix+'bc': // KASIH CREDIT DONG KALO COPAS
            if (!isOwner) return tobz.reply(from, `Perintah ini hanya untuk Owner anang`, id)
                bctxt = body.slice(4)
                txtbc = `*「 ANANG BOT BROADCAST 」*\n\n${bctxt}`
        ...
        case prefix+'ownergroup':
            ...
            break
        case prefix+'otagall': // FOR OWNER & ADMIN anang
        case prefix+'omentionall':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Owner anang', id)
        ...
        case prefix+'okickall':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isOwner) return tobz.reply(from, 'Perintah ini hanya untuk Admin anang', id)
            if (!isBotGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
        ...
        case prefix+'oadd':
            ...
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin anang', id)
            if (!isBotGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', id)
            try {
        ...
        case prefix+'oleave':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            if (!isOwner, !isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin anang', id)
            await tobz.sendText(from,'anang DIPERINTAHKAN KELUAR OLEH OWNER!!').then(() => tobz.leaveGroup(groupId))
            break
        case prefix+'leave':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group', id)
            if (!isGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin group', id)
        ...
        case prefix+'sider':
            if (!isGroupMsg) return tobz.reply(from, `Perintah ini hanya bisa di gunakan dalam group!`, id)                
            if (!quotedMsg) return tobz.reply(from, `Tolong Reply Pesan anang`, id)
            if (!quotedMsgObj.fromMe) return tobz.reply(from, `Tolong Reply Pesan anang`, id)
            try {
                ...
                console.log(err)
                tobz.reply(from, `Maaf, Belum Ada Yang Membaca Pesan anang atau Mereka Menonaktifkan Read Receipts`, id)    
            }
            break
        ...
        case prefix+'limit':
            ...
            break
        case prefix+'gfift': // Hanya Admin & Owner anang yang bisa gift Limit
            if (!isAdmin, !isOwner) return tobz.reply(from, `Maaf, perintah ini hanya dapat dilakukan oleh Admin anang!`, id)
...
╰────「 *A N A N G  B O T* 」───`, id)
        ...
        case prefix+'otogel':
            if (!isOwner) return tobz.reply(from, 'perintah ini hanya bisa di gunakan oleh owner anang!', id)
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            const togel = fetch('https://api.vhtear.com/togel&apikey=Anang1104*')
            //if (!togel.ok) throw new Error(`unexpected response ${togel.statusText}`)
            //if (!hstogel.ok) throw new Error(`unexpected response ${hstogel.statusText}`)
            const jsoner = togel.json()
            const { asue } = jsoner.result.hasil
            let xixixi = `*「 TOGEL 」*\n\n`
            for (let i = 0; i < asue.length; i++) {
                xixixi += `\n─────────────────\n\n*NEGARA* : ${asue[i].Negara}\n*SENIN* : ${asue[i].Senin}\n*Selasa* : ${asue[i].Selasa}\n*Rabu* : ${asue[i].Rabu}\n*Kamis* : ${asue[i].kamis}\n*Jumat* : ${asue[i].jumat}\n*Sabtu*: ${asue[i].sabtu}\n*Minggu*: ${asue[i].Minggu}\n\n─────────────────\n\n`
            }
            await tobz.sendText(from, xixixi, id)
            await limitAdd(serial)
            break
        ...
        case prefix+'ban':
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin anang!', id)
            for (let i = 0; i < mentionedJidList.length; i++) {
                if ((adminNumber).includes(mentionedJidList[i])) return tobz.reply(from,`Maaf ${pushname}, Kamu tidak bisa banned Admin anang!`, id)
        ...
        // LIST MENU
        case prefix+'runtime':
            tobz.reply(from, `anang telah aktif selama :\n${cts}`, id)
            break
        case prefix+'menu':
        case prefix+'help':
            var premma = isAdmin
            tobz.sendText(from, help(prefix, cts, premma, pendaftar))
            break
        case prefix+'ananggroup':
            tobz.reply(from, `Link Group anang : https://chat.whatsapp.com/KFuMvtNlg8KGElrgWE9csx\nJangan Lupa Join Ya Kak ${pushname}`, id)
            break
        ...
        case prefix+'adminmenu':
            if (!isAdmin) return tobz.reply(from, 'Perintah ini hanya untuk Admin anang', id)
        ...
        case 'bot?':
        case 'p':
            await tobz.reply(from, 'iyha.. ada apa kawanku..', id)
            break
        case 'iri':
        case 'Iri?':
        case prefix+'iri':
            tobz.sendPtt(from, './aris/iri.mp3', id)
            break
        case 'abangjago':
        case 'abang jago':
        case 'abgjgo':
        case 'abang':
        case 'jago':
        case prefix+'abangjago':
            tobz.sendPtt(from, './aris/abangjago.mp3', id)
            break
        case 'gatel':
        case prefix+'gatel':
            tobz.sendPtt(from, './aris/gatel.opus', id)
            break
        case 'bohong':
        case prefix+'bohong':
            tobz.sendPtt(from, './aris/bohong.mp3', id)
            break
        case 'tariksis':
        case 'tarekses':
        case 'tarik':
        case prefix+'tarekses':
            tobz.sendPtt(from, './aris/tarekses.mp3', id)
            break
        case 'welot':
        case prefix+'welot':
            tobz.sendPtt(from, './aris/welot.mp3', id)
            break
        case 'anjing':
        case 'Anjing':
        case 'anjg':
        ...
        case 'asu':
        case prefix+'anjing':
            tobz.reply(from, 'kuntull', id)
            tobz.sendPtt(from, './aris/anjing.mp3', id)
            break
        case 'pale':
        case 'papepale':
        case prefix+'pale':
            tobz.sendPtt(from, './aris/pale.mp3', id)
            break
        case prefix+'slap':
        case prefix+'tampar':
            tobz.reply(from, `bentar cuk..`, id)
            const tabokk = author.replace('@c.us', '')
            await tobz.sendGiphyAsStickerWithMentions(from, '@' + tabokk + 'https://media.giphy.com/media/S8507sBJm1598XnsgD/source.gif')
            tobz.sendTextWithMentions(from, '@' + tabokk + ' *nih.. mampus luu* ', id)
            break
        case 'peluk':
        case prefix+'peluk':
            const janjing = author.replace('@c.us', '')
            await tobz.sendGiphyAsSticker(from, 'https://media.giphy.com/media/od5H3PmEG5EVq/giphy.gif')
            tobz.sendPtt(from, `./aris/yamete.mp3`, id)
            break
        case prefix+'kutuk':
            if (!isGroupMsg) return tobz.reply(from, 'Maaf, perintah ini hanya dapat dipakai didalam grup!', id)
            if (mentionedJidList.length === 0) return tobz.reply(from, 'Tag member yang mau dikutuk\n\nContoh : #kutuk @tag | kalo berak kaga di siram', id)
            if (args.length === 1) return tobz.reply(from, 'Masukkan alasan kenapa menyantet dia!!\n\nContoh : #kutuk @tag | kalo berak kaga di siram', id)
            const terima2 = kutuk[Math.floor(Math.random() * (kutuk.length))]
            const target2 = arg.split('|')[0]
            const alasan2 = arg.split('|')[1]
            await tobz.sendTextWithMentions(from, `Kutuk kau ${target2} jadi *${terima2}*`)
            break
        //case '.':
            await tobz.reply(from, 'tunggu sebentar yahh..', id)
            const asupan = body.split('\n')
            const asupanx = asupan[Math.floor(Math.random() * asupan.length)]
            await tobz.sendFileFromUrl(from, 'http://sansekai.my.id/ptl_repost/${asupanx}', 'asupan.mp4', id)
            await tobs.reply(from, 'hehehe', id)
            break
            /*funcmd.asupan()
               .then(async (body) => {
                   const asupan = body.split('\n')
                   const asupanx = asupan[Math.floor(Math.random() * asupan.length)]
                   await tobz.sendFileFromUrl(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, 'asupan.mp4', 'Follow IG: https://www.instagram.com/ptl_repost untuk mendapatkan asupan lebih banyak.', id)
                   console.log('succes kirim vidio')
               })
               .catch(async (err) => {
                   console.eror(err)
        ...
        case prefix+'ptlvid':
            if(isReg(obj)) return
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            await tobz.reply(from, `media sedang dikirim , tunggu sampe10-20 detik`, id)
            fetch('https://raw.githubusercontent.com/VideFrelan/words/main/ptl.txt')
            .then(res => res.text())
            .then(body => {
                let pptl = body.split('\n')
                let pap = pptl[Math.floor(Math.random() * pptl.length)]
                tobz.sendFileFromUrl(from, pap, 'pptl.mp4', 'Nih asu', id)
        ...
        case prefix+'chika':
            ...
            .then(body => {
                ...
                tobz.sendFileFromUrl(from, `https://piyobot.000webhostapp.com/${chikax}.mp4`, 'chika.mp4', 'Nih asu', id)
        ...
        case prefix+'citacita':
            ...
            .then(body => {
                ...
                tobz.sendFileFromUrl(from, raya, 'citacita.mp3', id)
        ...
        case prefix+'katasenja':
            ...
            .then(body => {
                ...
                tobz.reply(from, randomsenja, id)
            })
            .catch(() => {
                tobz.reply(from, 'Ada yang Error!', id)
            })
        ...
        case prefix+'asupan':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            await tobz.reply(from, 'sabar...', id)
            ...
            case 'simi':
                ...
                fetch(`https://videfikri.com/api/simsimi?teks=${chat}`)
                })
                //.then(res => res.text())
                .then(async ({ jawaban }) => {
                    await tobz.reply(from, jawaban, id)
                })
                .catch(() => {
                    tobz.reply(from, 'Ada yang Error!', id)
                })
            ...
            case prefix+'toxic':
                ...
                if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
                limitAdd(serial)
                await tobz.reply(from, toxic(), id)
                break
        case prefix+'kritikdansaran':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            if (args.length === 1) return tobz.reply(from, '[❗] Kirim perintah *#kritikdansaran teks*\ncontoh : *#kritikdansaran Permisi Owner, Ada kritik/saran fitur toxic tambahin kata (yang kamu ingin)/ saran tambahin fitur (yang kamu ingin)*')
            const bugg = body.slice(11)
            //if(!bug) return
            if(isGroupMsg){
                tobz.sendText(ownerNumber, `*[KRITIK DAN SARAN]*\n*WAKTU* : ${time}\nNO PENGIRIM : wa.me/${sender.id.match(/\d+/g)}\nGroup : ${formattedTitle}\n\n${bugg}`)
                tobz.reply(from, 'Permintaanmu telah di kirim ke owner BOT, Terima kasih atas kritik/sarannya.' ,id)
            }else{
                tobz.sendText(ownerNumber, `*[KRITIK DAN SARAN]*\n*WAKTU* : ${time}\nNO PENGIRIM : wa.me/${sender.id.match(/\d+/g)}\n\n${bugg}`)
                tobz.reply(from, 'Permintaanmu telah di kirim ke owner BOT, Terima kasih atas kritik/sarannya.' ,id)
            }
        ...
        case prefix+'afk':
            if(isReg(obj)) return
            if (!isGroupMsg) return tobz.reply(from, `Perintah ini hanya bisa di gunakan dalam group!`, id)
            if (isAfkOn) return await tobz.reply(from, `Fitur AFK telah diaktifkan sebelumnya.`, id)
            const reason = arg ? arg : 'Nothing.'
            afk.addAfkUser(sender.id, time, reason, _afk)
            await tobz.reply(from, `Fitur AFK berhasil *diaktifkan*!\n\n➸ *Username*: ${pushname}\n➸ *Alasan*: ${reason}`, id)
            break
        /*case prefix+'reminder':
            //if (!q.includes('|')) return await piyo.reply(from, ind.wrongFormat(), id)
            const respon = arg
            const timeRemind = arg.substring(0, arg.indexOf('|') - 1)
            const messRemind = arg.substring(arg.lastIndexOf('|') + 2)
        ...
        const intervRemind = setInterval(async () => {
            if (Date.now() >= reminder.getReminderTime(sender.id, _reminder)) {
                await tobz.sendTextWithMentions(from, `⏰ *「 REMINDER 」* ⏰\n\nAkhirnya tepat waktu~ @${sender.id.replace('@c.us', '')}\n\n➸ *Pesan*: ${reminder.getReminderMsg(sender.id, _reminder)}`, '${reminder.getReminderMsg(sender.id, _reminder)}')
                //await tobz.sendTextWithMentions(from, '${reminder.getReminderMsg(sender.id, _reminder)}', id)
        ...
        /*case prefix+'sex':
            const cersex = () => new Promise((resolve, reject) => {
                ...
                fetch(`https://api.vhtear.com/cerita_sex&apikey=Anang1104*`)
                .then((result) => resolve(result))
                .catch((err) => reject(err))
            })
            .then(async ({ result }) => {
                await tobz.sendFileFromUrl(from, result.image, 'cersex.jpg', `── *「 ${result.judul} 」* ──\n\n${result.cerita}`, id)
        ...
        case prefix+'togel':
            ...
            await tobz.sendText(from, fox, id)
            break
        /*case prefix+'addlimit':
            ...
            tobz.sendTextWithMentions(from, `menambahkan ${args[1]} limit ke @${mentionedJidList[0].replace('@c.us', '')}`)
            break*/
        case prefix+'wa.me':
        case prefix+'wame':
            await tobz.reply(from, `*Neh kawan Link Nomor Wa Lu ${pushname}*\n\n*wa.me/${sender.id.replace(/[@c.us]/g, '')}*\n\n*Atau*\n\n*api.whatsapp.com/send?phone=${sender.id.replace(/[@c.us]/g, '')}*`, id)
            break
        case 'assalamualaikum':
        case 'Assalamualaikum':
            tobz.reply(from, 'Waalaikumsalam', id)
            break
// By Gimenz
        case prefix+'snk':
        ...
        case prefix+'share':
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (!isGroupAdmins) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan oleh admin group', id)
            const groupsu = await tobz.getGroupMembers(groupId)
            let hehi = `══✪〘 PENGUMUMAN 〙✪══\n\n${body.slice(6)}\n\n══════════════════\n`
            for (let i = 0; i < groupsu.length; i++) {
                hehi += '➥'
                hehi += ` @${groupsu[i].id.replace(/@c.us/g, '')}\n`
            }
            hehi += '══════════════════'
            await tobz.sendTextWithMentions(from, hehi)
            break
        case `${prefix}gift`:
            if (!isAdmin, !isOwner) return tobz.reply(from, `Maaf, perintah ini hanya dapat dilakukan oleh Admin anang!`, id)
            var found = false;
